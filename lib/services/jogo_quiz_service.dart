...
class JogoQuizService {
  static List<JogoQuizModel> jogoQuiz = [];
  static final List<String> frutas = [
    'Abacate',
    'Abacaxi',
    'Abobora',
    'Banana',
  ...
  static final List<String> animais = [
    'Abelha',
    'Baleia',
    'Preguica',
    'Borboleta',
  ...
  static Future<List<JogoQuizModel>> initList() async {
    jogoQuiz.addAll([
      // Frutas
      JogoQuizModel(
          id: 1,
  ...
  static Future<JogoQuizModel> findOne() async {
    jogoQuiz = await initList();
    int tamanho = jogoQuiz.length;
    int valor = Random().nextInt(tamanho);
    return jogoQuiz[valor];
  }
}
